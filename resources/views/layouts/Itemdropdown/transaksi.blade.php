<li
    class="relative px-3 py-1 inline-flex items-center w-full {!! request()->routeIs('Admin.nav.BarangMasuk') ? 'bg-gradient-to-r from-primary to-blue-500 rounded-lg text-white ': 'text-blue-500 ' !!} text-sm transition-colors duration-150">
...
<li
    class="relative px-3 py-1 inline-flex items-center w-full {!! request()->routeIs('Admin.nav.BarangKeluar') ? 'bg-gradient-to-r from-primary to-blue-500 rounded-lg text-white ': 'text-blue-500 ' !!} text-sm transition-colors duration-150">
...
<li
    class="relative px-3 py-1 inline-flex items-center w-full {!! request()->routeIs('Admin.nav.Pemesanan Barang') ? 'bg-gradient-to-r from-primary to-blue-500 rounded-lg text-white ': 'text-blue-500 ' !!} text-sm transition-colors duration-150">
