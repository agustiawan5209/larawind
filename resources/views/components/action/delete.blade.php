...
<div x-data="{ Modal: {{ isset($open) && $open ? 'true' : 'false' }}, working: false }" x-cloak wire:key="delete-{{ $value }}">
    <span x-on:click="Modal = true">
        <button class="p-1 text-red-600 rounded hover:bg-red-600 hover:text-white"><x-icon.trash /></button>
    </span>
